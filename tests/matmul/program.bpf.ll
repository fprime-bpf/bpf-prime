...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %6 = tail call ptr asm sideeffect ".byte 0x18, 0x11, 0x00, 0x00, ${1:c}, ${2:c}, ${3:c}, ${4:c}, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00", "={r1},i,i,i,i"(i32 5, i32 0, i32 0, i32 0) #4, !srcloc !3
  %7 = tail call ptr asm sideeffect ".byte 0x18, 0x11, 0x00, 0x00, ${1:c}, ${2:c}, ${3:c}, ${4:c}, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00", "={r1},i,i,i,i"(i32 6, i32 0, i32 0, i32 0) #4, !srcloc !4
  %8 = tail call ptr asm sideeffect ".byte 0x18, 0x11, 0x00, 0x00, ${1:c}, ${2:c}, ${3:c}, ${4:c}, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00", "={r1},i,i,i,i"(i32 7, i32 0, i32 0, i32 0) #4, !srcloc !5
...
10:                                               ; preds = %0, %10
  ...
  %20 = getelementptr inbounds [100 x float], ptr %2, i64 0, i64 %19
  store float %17, ptr %20, align 4, !tbaa !10
  %21 = add nsw i32 %18, 1
  store i32 %21, ptr %4, align 4, !tbaa !6
  %22 = icmp slt i32 %18, 99
...
30:                                               ; preds = %23, %34
  ...
  %33 = getelementptr inbounds nuw [100 x float], ptr %3, i64 0, i64 %32
  br label %37
...
37:                                               ; preds = %30, %37
  ...
  %40 = add nuw nsw i64 %38, %25
  %41 = getelementptr inbounds nuw [100 x float], ptr %1, i64 0, i64 %40
  %42 = load float, ptr %41, align 4, !tbaa !10
  %43 = mul nuw nsw i64 %38, 10
  %44 = add nuw nsw i64 %43, %31
  %45 = getelementptr inbounds nuw [100 x float], ptr %2, i64 0, i64 %44
...
51:                                               ; preds = %26, %51
  ...
  %55 = getelementptr inbounds [100 x float], ptr %3, i64 0, i64 %54
