...
// sqroot/sine/cosine/_atan2 are now real libm calls instead of the hand-rolled
// piecewise-linear/ternary-chain approximations this file used to have -- see
// tests/aberr/program.bpf.c for why (the BPF variant's WCET analysis needed
// the branch count gone; native/wasm are kept matching it for a fair
