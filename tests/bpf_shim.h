...
static long *(* const bpf_iter_num_new)(bpf_iter_num *it, unsigned long long start, unsigned long long end) = (void *) 4;
static long (* const bpf_iter_num_next)(bpf_iter_num *it) = (void *) 5;
static void *(* const bpf_iter_num_destroy)(bpf_iter_num *it) = (void *) 6;
