// ======================================================================
// \title  BPFPrimeTestTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef BPFPRIMETEST_BPFPRIMETESTTOPOLOGYDEFS_HPP
#define BPFPRIMETEST_BPFPRIMETESTTOPOLOGYDEFS_HPP
...
#include "BPFPrimeTest/Top/FppConstantsAc.hpp"
 ...
 */
namespace PingEntries {
    namespace BPFPrimeTest_rateGroup1 {enum { WARN = 3, FATAL = 5 };}
 ...
 *
 * The topology autocoder requires an object that carries state with the name `BPFPrimeTest::TopologyState`. Only the type
